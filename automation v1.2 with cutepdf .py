...
for x in range(2,total_num_rows):
	...
	try:
		...
		try:
			...
			sleep(5)
			autoit.win_wait("CutePDF Writer",1000000)
			autoit.win_activate("CutePDF Writer")
			autoit.control_send("CutePDF Writer", "Edit1", str(siteId))
			autoit.control_send("CutePDF Writer", "Button12", "Save")
			autoit.send("Enter")
